...
> 生成日期：2026-06-17 | 状态：执行中 | 最后更新：2026-06-28（v9 C 型交付版）
...
| 高性能推理服务 | vLLM、SGLang、llama.cpp、Ollama | vLLM 属于增长最快的 LLM serving 项目之一，主打 PagedAttention、Continuous Batching、OpenAI 兼容服务 | 作为 P2 概念加分，Step 4 |
